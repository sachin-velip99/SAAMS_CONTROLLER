...
const consumer = kafka.consumer({ groupId: process.env.GROUP_SAAMS })

module.exports.saamsAckConsumer = async () => {
    await consumer.connect()
    await consumer.subscribe({ topic: process.env.SAAMS_ACK_DATA })
